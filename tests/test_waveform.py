...
def test_initialization_from_array():
    ...
    waveform = smrd.Waveform.from_array(data)
...
def test_initialization_with_header_fields():
    ...
    waveform = smrd.Waveform.from_array(common.create_random_waveform_data(), **fields)
...
def test_initialization_with_illegal_header_value():
    smrd.Waveform.from_array(common.create_random_waveform_data(), version='Bad version')
...
def test_serialize_and_deserialize():
    ...
    with io.BytesIO() as stream:
        ...
        deserialized_waveform = smrd.Waveform.deserialize_from(stream.read)
...
def test_to_and_from_bytes():
    ...
    deserialized_waveform = smrd.Waveform.from_bytes(waveform.to_bytes())
...
def test_serialization_with_header_fields():
    ...
    waveform = smrd.Waveform.from_array(data, **properties)
    deserialized_waveform = smrd.Waveform.from_bytes(waveform.to_bytes())
