...
class Dataset(object):
    ...
    def read_acquisition(self, acqnum):
        ...
        acq = smrd.Acquisition(self._dataset['data'][acqnum]['head'])
    ...
    def read_image(self, impath, imnum):
        ...
        im = smrd.Image(self._dataset[impath]['header'][imnum], self._dataset[impath]['attributes'][imnum])

        # copy the data
        # smrd complex data is stored as pairs named real and imag
    ...
    def read_waveform(self, wavnum):
        ...
        wav = smrd.Waveform(header_array)
